...
public class Scr_interact_shrine : MonoBehaviour, IInteract
{
    ...
    private Scr_living_stats m_player;
    ...
    private void Start()
    {
        ...
        m_interactUI = Scr_global_canvas.ShrineWindow.GetComponent<Scr_ui_window>().m_panels[0];
    }
    ...
    private void PlayerInteraction()
    {
        ...
        //Scr_player_controller.FreezePlayer = true; DEL
    }
